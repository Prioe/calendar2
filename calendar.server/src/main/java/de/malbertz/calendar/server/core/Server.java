         ...
         try {
            ...
            while (this.listen) {
               ...
               try {
                  ...
                  ClientThread client = new ClientThread(socket, commandQueue);
                  log.debug("Successfully created ClientThread: " + client);
            ...
            log.fatal("An fatal error occured. Stopping server thread ...", e);
            this.stopServerThread();
         }
      }
